![Banner](https://private-user-images.githubusercontent.com/74038190/241765440-80728820-e06b-4f96-9c9e-9df46f0cc0a5.gif?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..the7JahJSBCtKHPaHbwexDJR40Cwi9viASpsQ65RVoc)

## Hi there, I'm Ahmed Medina! 👋

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Ahmed_Medina-0077B5)](https://www.linkedin.com/in/ahmed-medina108/)

My career is a unique blend of engineering and development, where I have built solutions ranging from automated control systems with microcontrollers and wireless modules to robust testing frameworks using Python, Selenium, and Pytest. I believe that discipline, attention to detail, and a self-taught mindset are key to solving complex problems.

When I’m not writing code or designing test cases, you’ll likely find me sharing knowledge as a Yoga Instructor—a practice that has significantly strengthened my communication, leadership, and organizational skills.

## 🧪 QA Engineer & Automation Specialist

Bilingual QA Engineer with experience in manual and automated testing, backed by a solid background in Mechatronics Engineering. Passionate about software quality and process automation.
...
A web automation framework for the "Urban Routes" application, built using Python, Selenium, and Pytest.
...
Designed and implemented for the Autonomous University of Yucatán (UADY) using Xbee modules, Chipkit, and LabView.

[![LabView](https://img.shields.io/badge/LabView-Automation-FFDB33)](https://www.ni.com/es-mx/shop/labview.html)
[![XBee](https://img.shields.io/badge/XBee-Wireless_Modules-0080A8)](https://www.digi.com/xbee)
[![C++](https://img.shields.io/badge/C++-Embedded_Systems-00599C)](https://isocpp.org/)

### ⚙️ Intelligent Dosing System
A control system for raw material dosing integrated into a production line for nanomaterials research.
...
**January 2014 - July 2014 | Mérida, Yucatán, México**

- Designed and executed manual and regression tests for pharmaceutical software.
- Validated database integrity through SQL queries.
- Maintained professional communication with international clients in English.

### 🔬 CICY - Automation Engineer
**August 2012 - February 2013 | Mérida, Yucatán, México**

- Optimized production lines for tensile specimens.
- Developed an intelligent dosing control system.
- Implemented systems using PIC microcontrollers and XBee communication.
- Awarded a scholarship offer due to high autonomy and responsibility.

### 🧘 Simha Yoga - Yoga Instructor
**June 2014 - Present | Mérida, Yucatán, México**

- Developed strong communication and group management skills.
- Class planning and event organization.
- Cultivated high levels of discipline and personal responsibility.

---

## 📚 Education

- **Quality Assurance Engineering** - TripleTen Online Bootcamp (2025)
- **B.S. in Mechatronics Engineering** - Autonomous University of Yucatán (2012)
- **Computer Vision with LabView** - CICY (Professional Diploma, 2012)
